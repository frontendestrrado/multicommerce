  ...
  if (product.offer_price !== false) {
    return (
      <p className="ps-product__price offer">
        {/* <span style={{display:product.offer === ""?'none':'block'}}>SAR {product.offer_price ? product.offer_price : 0}</span> */}
        <span>SAR {product.offer === "" ? product.actual_price : product.offer_price}</span>
