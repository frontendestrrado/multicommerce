  ...
  return (
    ...
    >
        ...
        <div className="container">
          <div className="header__content-left">
            <Link href="/home/auto-part">
              <a className="ps-logo">
                <img src="/static/img/logo-autopart.png" alt="Kangtao" />
              </a>
            </Link>
            <div className="menu--product-categories">
              ...
              <div className="menu__content">
                <ul className="menu--dropdown">{menuCategoriesView}</ul>
              </div>
            </div>
          </div>
      ...
      <nav className="navigation">
        <div className="container">
          <Menu source={menuAutopart} className="menu menu--technology" />
        </div>
      </nav>
    </header>
  );
