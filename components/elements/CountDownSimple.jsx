...
class CountDownSimple extends Component {
  ...
  componentDidMount() {
    this.interval = setInterval(() => {
      const { timeTillDate, timeFormat, styleAdd } = this.props;
      ...
      this.setState({ days, hours, minutes, seconds, styleAdd });
    }, 1000);
  }
  ...
  render() {
    const { days, hours, minutes, seconds, styleAdd } = this.state;
    return (
      <ul className={`ps-countdown ${styleAdd}`}>
        <li>
