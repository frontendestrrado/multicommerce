...
const PartialAuctionDescription = ({ product }) => (
  <div className="ps-document">
    {product?.content ? product?.content : "NA"}
    ...
    <p>
      ...
      charging port before plugging in. Samsung hasn’t reinvented the wheel with
      the design of the Galaxy S7, but it didn’t need to. The Gala S6 was an
      excellently styled device, and the S7 has managed to improve on that.
    </p> */}
  </div>
);

export default PartialAuctionDescription;
