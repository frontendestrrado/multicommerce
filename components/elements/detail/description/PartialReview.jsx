...
function PartialReview({ product }) {
    ...
    if (review !== "" && name !== "title") {
      ...
      if (userdata === undefined || userdata === null) {
        ...
        if (responseData && responseData.httpcode == 200) {
          ...
          return false;
          // if (responseData.httpcode == "Not available") {
          //   // Object?.keys(responseData.errors)?.forEach((key) => {
          //   //   notification["error"]({
          //   //     message: key,
          //   //     description: responseData.errors[key],
          //   //     duration: 1,
          //   //   });
          //   // });
          //   notification["error"]({
          ...
          //     notification["error"]({
          //       message: key,
          //       description: responseData.errors[key][0],
          //       duration: 1,
          //     });
          //   });
          // }
  ...
  function numberOfRating(ratingNumber) {
    return Math.ceil(
      (product.review?.filter((review) => review.rating == ratingNumber)
        ?.length /
      ...
      <div className="row">
        <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12 ">
          <div className="ps-block--average-rating">
            <div className="ps-block__header">
              <h3>
                {product.product.rating ? product.product.rating + ".00" : 0}
              </h3>
        ...
        <div className="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12 ">
          ...
          <div className="form-group form-group__rating">
            <label className="mr-4">Your rating of this product</label>
