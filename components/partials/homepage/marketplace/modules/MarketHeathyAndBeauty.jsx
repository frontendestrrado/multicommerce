...
const MarketHeathyAndBeauty = ({ collectionSlug }) => {
  ...
  async function getProducts() {
    setLoading(true);
    const responseData = await getProductsByCategoriesHelper(collectionSlug);
    if (responseData) {
    ...
    <div className="ps-block--products-of-category">
      ...
      <div className="ps-block__slider">
        <Slider {...carouselSingle} className="ps-carousel">
          <a>
            <img src="/static/img/slider/home-3/healthy-1.jpg" alt="Kangtao" />
          </a>
          <a>
            <img src="/static/img/slider/home-3/healthy-2.jpg" alt="Kangtao" />
          </a>
          <a>
            <img src="/static/img/slider/home-3/healthy-3.jpg" alt="Kangtao" />
          </a>
        </Slider>
      </div>
