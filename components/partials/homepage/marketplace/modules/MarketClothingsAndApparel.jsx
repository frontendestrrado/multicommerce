    ...
    <div className="ps-block--products-of-category">
      ...
      <div className="ps-block__slider">
        <Slider {...carouselSingle} className="ps-carousel">
          <a>
            <img src="/static/img/slider/home-3/clothing-1.jpg" alt="Kangtao" />
          </a>
          <a>
            <img src="/static/img/slider/home-3/clothing-2.jpg" alt="Kangtao" />
          </a>
          <a>
            <img src="/static/img/slider/home-3/clothing-3.jpg" alt="Kangtao" />
          </a>
        </Slider>
      </div>
