...
const ShopItemsFeatureProducts = ({ columns = 4, pageSize = 12 }) => {
  ...
  async function getProducts(params) {
    ...
    const responseData = await ProductRepository.getFeaturedProducts(
      payload,
      params_payload
    );
  ...
  async function getProductsbyfilters() {
    ...
    const responseData = await ProductRepository.getFeaturedProductsbyFilter(
      payload
    );
    if (responseData) {
...
export default ShopItemsFeatureProducts;
