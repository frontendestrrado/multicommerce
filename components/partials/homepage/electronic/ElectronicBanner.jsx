          ...
          <div className="ps-section__left">
            <Slider {...carouselSettings}>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-7/1.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-7/2.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-7/3.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
            </Slider>
