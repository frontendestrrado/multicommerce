          ...
          <div className="ps-section__center">
            <Slider {...carouselSettings}>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-5/1.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-5/2.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
              <div className="item">
                <Link href="/shop">
                  <a>
                    <img src="/static/img/slider/home-5/3.jpg" alt="Kangtao" />
                  </a>
                </Link>
              </div>
