...
const ShopItemsShockingSale = ({ columns = 4, pageSize = 12 }) => {
  ...
  async function getProducts(params) {
    ...
    const responseData = await ProductRepository.getShockingSaleProducts(
      payload,
      params_payload
    );
  ...
  async function getProductsbyfilters() {
    ...
    const responseData =
      await ProductRepository.getShockingSaleProductsbyFilter(payload);
    if (responseData) {
      setProductItems(responseData.items);
      setTotal(responseData.totalItems);
      setTimeout(
...
export default ShopItemsShockingSale;
