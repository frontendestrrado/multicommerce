                ...
                <div className="ps-block__container">
                  ...
                  <div className="ps-block__content">
                    <p>
                      ...
                      retailer was established in May 2012 with the aim and
                      vision to become the one-stop shop for retail in New York
                      with implementation of best practices both online
                    </p>
                    <span className="ps-block__divider"></span>
                    <p>
                      <strong>Address</strong> 325 Orchard Str, New York, NY
                      10002
                    </p>
                    <figure>
                  ...
                  <Slider {...carouselStandard} className="ps-carousel">
                    {relatedProduct &&
                      relatedProduct.map((product) => (
                        <ProductOffline product={product} key={product.id} />
                      ))}
                  </Slider>
                </div>
              </div>
