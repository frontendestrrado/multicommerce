  ...
  <div className="ps-vendor-dashboard">
    <div className="container">
      <div className="ps-section__header">
        ...
        <p>
          Designed base on WC Vendor Plugin. Kangtao also fully comptatiable
          with other popular plugins as Dokan, YITH, etc .Can help you turns
          your site into multi-vendor eCommerce site.
        </p>
      </div>
              ...
              <table className="table ps-table ps-table--vendor">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Nov 4, 2019</td>
                    <td>
                      <a href="#">Unero Military Classical Backpack</a>
                    </td>
                    <td>$42.35</td>
                    <td>10</td>
                    <td>$211.00</td>
                  ...
                  <tr>
                    <td>Nov 4, 2019</td>
                    <td>
                      <a href="#">Sleeve Linen Blend Caro Pana T-Shirt</a>
                    </td>
                    <td>$23.35</td>
                    <td>80</td>
                    <td>$935.00</td>
                  ...
                  <tr>
                    <td>Nov 30, 2019</td>
                    <td>
                      <a href="#">Harman Kardon Onyx Studio 2.0</a>
                    </td>
                    <td>$299.35</td>
                    <td>14</td>
                    <td>$2095.00</td>
                  ...
                  <tr>
                    <td>Nov 30, 2019</td>
                    <td>
                      <a href="#">Korea Long Sofa Fabric In Blu Navy Color</a>
                    </td>
                    <td>$299.35</td>
                    <td>5</td>
                    <td>$6095.00</td>
